...
dataset_train = pd.read_csv('westminster.csv', header=0, index_col=0)
training_set = dataset_train.iloc[6:, 0:1].values #90%
...
dataset_test = pd.read_csv('westminster.csv', header=0, index_col=0)
