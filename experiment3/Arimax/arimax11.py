...
import requests
import io
dataset_train = "https://raw.githubusercontent.com/wiut-tutor2022/ML_models_for_efficient_classroom_usage3/master/Data/westminster.csv"
s = requests.get(dataset_train).content
dataset_train = pd.read_csv(io.StringIO(s.decode('utf-8')), header=0, index_col=0)

one_third_index = len(dataset_train) // 3
#training_set = dataset_train.iloc[:one_third_index, 1:2].values # takes 1/3 of attendance data
training_set = dataset_train.iloc[3:, 1:2].values # takes 1/3 of attendance data
...
dataset_test = "https://raw.githubusercontent.com/wiut-tutor2022/ML_models_for_efficient_classroom_usage3/master/Data/westminster.csv"
s = requests.get(dataset_test).content
dataset_test = pd.read_csv(io.StringIO(s.decode('utf-8')), header=0, index_col=0)
