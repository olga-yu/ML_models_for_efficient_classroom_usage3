...
file_path = os.path.join(os.path.expanduser('~'), 'Downloads', 'Temperature-data 9-13.csv')
#file_path = os.path.join(os.path.expanduser('~'), 'Downloads', 'Temperature-data 14-18.csv')
...
try:
    ...
    plt.ylabel('Temperature (%)', fontsize=24, color='red')  # Change ylabel to humidity
    plt.title('Temperature-Time Plot from 9 to 13', fontsize=20)  # Change title
    plt.grid(True)
