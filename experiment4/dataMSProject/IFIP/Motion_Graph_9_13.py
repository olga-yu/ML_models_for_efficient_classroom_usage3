...
file_path = os.path.join(os.path.expanduser('~'), 'Downloads', 'Motion-data 9-13 User2.csv')
...
try:
    ...
    plt.title('Motion-Time Plot from 9:00 to 13:00 User', fontsize=20)  # Change title
    plt.grid(True)
