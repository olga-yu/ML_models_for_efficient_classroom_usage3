...
dataset_train = pd.read_csv('../data/output_9_18_8.csv', header=0, index_col=0) # processes dataset with minutes
training_set = dataset_train.iloc[3:, 1:].values # takes 1/3 of attendance from data
print(training_set)
